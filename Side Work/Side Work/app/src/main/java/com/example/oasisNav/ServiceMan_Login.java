...
public class ServiceMan_Login extends AppCompatActivity {
    ...
    static String URL_LOGIN="https://ingratiating-jacks.000webhostapp.com/Oasis/login.php";
    @Override
                    ...
                    if(success.equals("1")) {
                        for (int i = 0; i < jsonArray.length(); i++) {
                           ...
                           /*  String name = jsonObject1.getString("id");
                            ...
                            startActivity(new Intent(getApplicationContext(), ServicemanHome.class));
                        ...
                        Toast.makeText(ServiceMan_Login.this, "Invalid Username and Password "+jsonObject.getString("message"), Toast.LENGTH_LONG).show();
                        progressBar.setVisibility(View.GONE);
                    }
